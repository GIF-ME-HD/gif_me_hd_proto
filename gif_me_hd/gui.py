...
class EncryptTab(QWidget):
    ...
    def initUI(self):
        ...
        preview_buttons_layout.addWidget(self.zoomout_btn, 0, 0)
        preview_buttons_layout.addWidget(self.zoomin_btn, 0, 1)
        preview_buttons_layout.addWidget(self.prev_frame_button, 1, 0)
        preview_buttons_layout.addWidget(self.next_frame_button, 1, 1)
